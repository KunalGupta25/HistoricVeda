...
;(() => {
  var me = (n, b) => () => (b || n((b = { exports: {} }).exports, b), b.exports)
  var Qe = me(() => {
    'use strict'
    window.tram = (function (n) {
      ...
      function V (t, a, l) {
        return (
          '#' + ((1 << 24) | (t << 16) | (a << 8) | l).toString(16).slice(1)
        )
      }
      function C () {}
      function W (t, a) {
      ...
      var K = (function (t, a, l) {
          ...
          function N (j, le) {
            ...
            return (
              ...
              (A.open = function (be) {
                if (
                  ((te = {}),
                  u(be) ? (te = be.call(A, Re, ve, A, j)) : f(be) && (te = be),
                  f(te))
                )
        ...
        J = {
          ease: [
            ...
            function (t, a, l, f) {
              ...
              return (
                a +
                l * (-2.75 * d * u + 11 * u * u + -15.5 * d + 8 * u + 0.25 * t)
              )
            }
          ],
          'ease-in': [
          ...
          'ease-out': [
            ...
            function (t, a, l, f) {
              ...
              return (
                a +
                l * (0.3 * d * u + -1.6 * u * u + 2.2 * d + -1.8 * u + 1.9 * t)
              )
            }
          ],
          'ease-in-out': [
          ...
          'ease-in-out-expo': [
            ...
            function (t, a, l, f) {
              return t === 0
                ...
                ? a + l
                : (t /= f / 2) < 1
                ? (l / 2) * Math.pow(2, 10 * (t - 1)) + a
                : (l / 2) * (-Math.pow(2, -10 * --t) + 2) + a
            }
          ],
          'ease-in-circ': [
          ...
          'ease-in-out-circ': [
            ...
            function (t, a, l, f) {
              return (t /= f / 2) < 1
                ? (-l / 2) * (Math.sqrt(1 - t * t) - 1) + a
                : (l / 2) * (Math.sqrt(1 - (t -= 2) * t) + 1) + a
            }
          ],
          'ease-in-back': [
          ...
          'ease-in-out-back': [
            ...
            function (t, a, l, f, u) {
              return (
                u === void 0 && (u = 1.70158),
                (t /= f / 2) < 1
                  ? (l / 2) * t * t * (((u *= 1.525) + 1) * t - u) + a
                  : (l / 2) *
                      ((t -= 2) * t * (((u *= 1.525) + 1) * t + u) + 2) +
                    a
              )
            }
          ]
        ...
        w = ['-webkit-', '-moz-', '-o-', '-ms-'],
        T = function (t) {
          if (t in _.style) return { dom: t, css: t }
          var a,
            l,
            f = '',
            u = t.split('-')
          for (a = 0; a < u.length; a++)
            f += u[a].charAt(0).toUpperCase() + u[a].slice(1)
          for (a = 0; a < v.length; a++)
            if (((l = v[a] + f), l in _.style)) return { dom: l, css: w[a] + t }
        },
        L = (b.support = {
      ...
      var m = (b.frame = (function () {
        ...
        r = K(function (t) {
          function a (z, re) {
            ...
            if (!re.weak || !this.props[ae]) {
              var Ae = ye[0],
                Ee = this.props[ae]
              return (
                Ee || (Ee = this.props[ae] = new Ae.Bare()),
                Ee.init(this.$el, he, ye, re),
                Ee
              )
            }
          }
            ...
            if (z) {
              ...
              if (ae == 'object') {
                ...
                Re.call(
                  ...
                  ve.call(this),
                  ye > 0 &&
                    ((this.timer = new $({ duration: ye, context: this })),
                    (this.active = !0),
                    re && (this.timer.complete = d))
                var Ae = this,
                  Ee = !1,
                  Be = {}
                m(function () {
          ...
          function ve () {
            ...
            for (z in this.props)
              (re = this.props[z]), re.active && he.push(re.string)
            ;(he = he.join(',')),
              this.style !== he &&
                ((this.style = he), (this.el.style[L.transition.dom] = he))
          }
          function Re (z, re, he) {
            var ae,
              ye,
              ...
              (Ae = z[ae]),
                ae in oe
                  ? (pe.transform || (pe.transform = {}),
                    (pe.transform[ae] = Ae))
                  : (P.test(ae) && (ae = p(ae)),
                    ae in O ? (pe[ae] = Ae) : (Ee || (Ee = {}), (Ee[ae] = Ae)))
            for (ae in pe) {
        ...
        s = K(function (t) {
          ...
          function f (d) {
            ...
            return (N ? V(N[1], N[2], N[3]) : d).replace(
              /#(\w)(\w)(\w)$/,
              '#$1$1$2$2$3$3'
            )
          }
          ...
          ;(t.init = function (d, N, j, le) {
            ...
            j[2] && (A = j[2]),
              ...
              (this.name = A),
              (this.type = j[1]),
              (this.duration = y(N[1], this.duration, u.duration)),
              (this.ease = l(N[2], this.ease, u.ease)),
              (this.delay = y(N[3], this.delay, u.delay)),
              (this.span = this.duration + this.delay),
              (this.active = !1),
              (this.nextStyle = null),
              (this.auto = we.test(this.name)),
              (this.unit = le.unit || this.unit || G.defaultUnit),
              (this.angle = le.angle || this.angle || G.defaultAngle),
              G.fallback || le.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    'ms' +
                    (this.ease != 'ease' ? de + J[this.ease][0] : '') +
              ...
              switch (N) {
                ...
                case F:
                  if (A) {
                    ...
                    if (N.test(d))
                      return d.charAt(0) == '#' && d.length == 7 ? d : f(d)
                  }
                  j = 'hex or rgb string'
                  break
                case R:
          ...
          ;(t.init = function () {
            ...
            (t.values = function (f) {
              var u,
                d = {}
              return (
                l.call(this, f, function (N, j, le) {
                  ;(d[N] = j),
                    this.current[N] === void 0 &&
                      ((u = 0),
                      ~N.indexOf('scale') && (u = 1),
                      (this.current[N] = this.convert(u, le)))
                }),
                d
              )
            })
        ...
        c = K(function (t) {
          ...
          var N = { ease: J.ease[1], from: 0, to: 1 }
          ;(t.init = function (A) {
            ;(this.duration = A.duration || 0), (this.delay = A.delay || 0)
            var ee = A.ease || N.ease
            J[ee] && (ee = J[ee][1]),
              typeof ee != 'function' && (ee = N.ease),
              (this.ease = ee),
              (this.update = A.update || C),
              (this.complete = A.complete || C),
            ...
            (t.play = function () {
              this.active ||
                (this.start || (this.start = S()), (this.active = !0), a(this))
            }),
            (t.stop = function () {
            ...
            (t.render = function (A) {
              ...
              if (te < this.duration) {
                ...
                return (
                  (ee = this.startRGB
                    ? d(this.startRGB, this.endRGB, ve)
                    : u(this.begin + ve * this.change)),
          ...
          ;(t.init = function (l) {
            ...
            (t.render = function (l) {
              ...
              for (f = d; f--; )
                (u = this.tweens[f]),
                  u.context &&
                    (u.render(l), (this.current[u.name] = u.value), (N = !0))
              return N
      ...
      ;(b.fallback = function (t) {
        ...
        (b.delay = function (t, a, l) {
          return new $({ complete: a, duration: t, context: l })
        }),
      ...
      var i = n.style,
        x = n.css,
        D = { transform: L.transform && L.transform.css },
        O = {
          color: [e, F],
  ...
  var ut = me((En, at) => {
    ...
    at.exports = (function () {
        ...
        (n.debounce = function (v, w, T) {
          var L,
            ...
            r = function () {
              ...
              o < w
                ? (L = setTimeout(r, w - o))
                : ((L = null), T || ((S = v.apply(X, B)), (X = B = null)))
            }
          return function () {
      ...
      var ce = /(.)^/,
        ...
        _ = /^\s*(\w|\$)+\s*$/
      return (
        (n.template = function (v, w, T) {
          !w && T && (w = T), (w = n.defaults({}, w, n.templateSettings))
          var L = RegExp(
              [
                (w.escape || ce).source,
                (w.interpolate || ce).source,
                (w.evaluate || ce).source
              ].join('|') + '|$',
              'g'
            ),
            B = 0,
...
` +
  ...
  var ke = me((kn, mt) => {
    ...
    function ft (n) {
      ue.env() &&
        (Se(n.design) && Le.on('__wf_design', n.design),
        Se(n.preview) && Le.on('__wf_preview', n.preview)),
        Se(n.destroy) && Le.on('__wf_destroy', n.destroy),
        n.ready && Se(n.ready) && nn(n)
    }
    function nn (n) {
      if (Ke) {
        n.ready()
    ...
    function dt (n) {
      Se(n.design) && Le.off('__wf_design', n.design),
        Se(n.preview) && Le.off('__wf_preview', n.preview),
        Se(n.destroy) && Le.off('__wf_destroy', n.destroy),
        n.ready && Se(n.ready) && rn(n)
    }
    function rn (n) {
    ...
    var Je
    ht &&
      tn.on('touchstart mousedown', function (n) {
        Je = n.target
      })
    ue.validClick = ht
      ? function (n) {
    ...
    function pt () {
      Pe && (Pe.reject(), Le.off('load', Pe.resolve)),
        (Pe = new De.Deferred()),
        Le.on('load', Pe.resolve)
    }
  ...
  var bt = me((_n, wt) => {
    'use strict'
    var gt = ke()
    gt.define('brand', (wt.exports = function () {}), function (n) {
      var b = {},
        p = document,
        E = n('html'),
        V = n('body'),
      ...
      b.ready = function () {
        ...
        ;/\.webflow\.io$/i.test(H) && W.hostname !== H && (I = !0),
          I &&
            !M &&
            ((Z = Z || K()), J(), setTimeout(J, 500), n(p).off(y, ne).on(y, ne))
      }
      function ne () {
        var I =
          p.fullScreen ||
      ...
      function K () {
        var I = n('<a class="w-webflow-badge"></a>').attr(
            'href',
  ...
  var xt = me((On, yt) => {
    ...
    rt.define(
      'edit',
      (yt.exports = function (n, b, p) {
        if (
          ((p = p || {}),
          (rt.env('test') || rt.env('frame')) && !p.fixture && !ln())
        )
          return { exit: 1 }
        var E = {},
          V = n(window),
        ...
        function I (F) {
          return function (R) {
            ...
            ;(R.thirdPartyCookiesSupported = F),
              H(Q(R.scriptPath), function () {
                window.WebflowEditor(R)
              })
          }
        }
        function H (F, R) {
          n.ajax({ type: 'GET', url: F, dataType: 'script', cache: !0 }).then(
            R,
            Y
          )
        }
        ...
        function Q (F) {
          return F.indexOf('//') >= 0
            ? F
            : q('https://editor-api.webflow.com' + F)
        }
        function q (F) {
        ...
        function P (F) {
          ...
          var U = function (se) {
            se.data === 'WF_third_party_cookies_unsupported'
              ? (k(R, U), F(!1))
              : se.data === 'WF_third_party_cookies_supported' &&
                (k(R, U), F(!0))
          }
          ;(R.onerror = function () {
            k(R, U), F(!1)
        ...
        function n (p) {
          ...
          function y (k) {
            var F = k.type,
              R = k.tagName
            return !!(
              (R === 'INPUT' && W[F] && !k.readOnly) ||
              (R === 'TEXTAREA' && !k.readOnly) ||
              k.isContentEditable
            )
          }
          function Z (k) {
            k.getAttribute('data-wf-focus-visible') ||
              k.setAttribute('data-wf-focus-visible', 'true')
          }
          function ne (k) {
            k.getAttribute('data-wf-focus-visible') &&
              k.removeAttribute('data-wf-focus-visible')
          }
          function K (k) {
            k.metaKey ||
              k.altKey ||
              k.ctrlKey ||
              (M(p.activeElement) && Z(p.activeElement), (E = !0))
          }
          function J () {
            E = !1
          }
          ...
          function H (k) {
            M(k.target) &&
              k.target.hasAttribute('data-wf-focus-visible') &&
              ((V = !0),
          ...
          function P (k) {
            ;(k.target.nodeName &&
              k.target.nodeName.toLowerCase() === 'html') ||
              ((E = !1), q())
          }
          document.addEventListener('keydown', K, !0),
            ...
            Q(),
            p.addEventListener('focus', I, !0),
            p.addEventListener('blur', H, !0)
        }
        function b () {
      ...
      (Ot.exports = function () {
        ...
        function E (W) {
          var M = W.target,
            y = M.tagName
          return (
            (/^a$/i.test(y) && M.href != null) ||
            (/^(button|textarea)$/i.test(y) && M.disabled !== !0) ||
            (/^input$/i.test(y) &&
              /^(button|reset|submit|radio|checkbox)$/i.test(M.type) &&
              !M.disabled) ||
            (!/^(button|input|textarea|select|a)$/i.test(y) &&
              !Number.isNaN(Number.parseFloat(M.tabIndex))) ||
            /^audio$/i.test(y) ||
            (/^video$/i.test(y) && M.controls === !0)
          )
        }
        function V (W) {
          E(W) &&
      ...
      (Tt.exports = function (n, b) {
        ...
        function H (q) {
          if (!q.getAttribute('hreflang')) {
            var P =
              (V && q.getAttribute('href-disabled')) || q.getAttribute('href')
            if (((M.href = P), !(P.indexOf(':') >= 0))) {
              ...
              if (
                ...
                var F = n(M.hash)
                F.length && K.push({ link: k, sec: F, active: !1 })
                return
              }
              if (!(P === '#' || P === '')) {
                var R =
                  M.href === W.href || P === J || (Z.test(P) && ne.test(J))
                Q(k, y, R)
              }
            }
          }
  ...
  var Rt = me((Cn, Ct) => {
    ...
    $e.define(
      ...
      (Ct.exports = function (n) {
        ...
        function k (_, v) {
          ...
          switch (v) {
            case 'add':
              ;(w = _.attr('tabindex')),
                w
                  ? _.attr('data-wf-tabindex-swap', w)
                  : _.attr('tabindex', '-1')
              break
            case 'remove':
              ;(w = _.attr('data-wf-tabindex-swap')),
                w
                  ? (_.attr('tabindex', w),
                    _.removeAttr('data-wf-tabindex-swap'))
        ...
        function U (_, v) {
          ...
          if (w !== T) {
            var L = ce(_, w, T),
              ...
              X = function () {
                var m = Date.now() - B
                window.scroll(0, fe(w, T, m, L)),
                  m <= L ? M(X) : typeof v == 'function' && v()
              }
            M(X)
          }
        }
        ...
        function de () {
          var { WF_CLICK_EMPTY: _, WF_CLICK_SCROLL: v } = b
          C.on(v, K, F),
            C.on(_, ne, function (w) {
              w.preventDefault()
            }),
  ...
  var It = me((Rn, St) => {
    ...
    fn.define(
      'touch',
      (St.exports = function (n) {
        var b = {},
          p = window.getSelection
        ;(n.event.special.tap = { bindType: 'click', delegateType: 'click' }),
          (b.init = function (C) {
            return (
              (C = typeof C == 'string' ? n(C).get(0) : C), C ? new E(C) : null
            )
          })
        function E (C) {
          var W = !1,
            M = !1,
            y = Math.min(Math.round(window.innerWidth * 0.04), 40),
            Z,
            ne
          C.addEventListener('touchstart', K, !1),
            C.addEventListener('touchmove', J, !1),
            C.addEventListener('touchend', I, !1),
            C.addEventListener('touchcancel', H, !1),
            C.addEventListener('mousedown', K, !1),
            C.addEventListener('mousemove', J, !1),
            C.addEventListener('mouseup', I, !1),
            C.addEventListener('mouseout', H, !1)
          function K (Q) {
            var q = Q.touches
            ;(q && q.length > 1) ||
              ((W = !0),
              q ? ((M = !0), (Z = q[0].clientX)) : (Z = Q.clientX),
              (ne = Z))
          }
          function J (Q) {
            if (W) {
              ...
              ;(ne = P),
                Math.abs(k) > y &&
                  p &&
                  String(p()) === '' &&
                  (V('swipe', Q, { direction: k > 0 ? 'right' : 'left' }), H())
            }
          }
          function I (Q) {
          ...
          function Y () {
            C.removeEventListener('touchstart', K, !1),
              C.removeEventListener('touchmove', J, !1),
              C.removeEventListener('touchend', I, !1),
              C.removeEventListener('touchcancel', H, !1),
              C.removeEventListener('mousedown', K, !1),
              C.removeEventListener('mousemove', J, !1),
              C.removeEventListener('mouseup', I, !1),
              C.removeEventListener('mouseout', H, !1),
              (C = null)
          }
          this.destroy = Y
        }
        function V (C, W, M) {
          var y = n.Event(C, { originalEvent: W })
  ...
  var Ft = me((Sn, Dt) => {
    ...
    var it = window.jQuery,
      ...
      Ve = {
        ...
        intro: function (n, b) {
          b.__wf_intro ||
            ((b.__wf_intro = !0), it(b).triggerHandler(Ie.types.INTRO))
        },
        outro: function (n, b) {
          b.__wf_intro &&
            ((b.__wf_intro = null), it(b).triggerHandler(Ie.types.OUTRO))
        }
      }
    Ie.triggers = {}
    Ie.types = { INTRO: 'w-ix-intro' + Wt, OUTRO: 'w-ix-outro' + Wt }
    Ie.init = function () {
  ...
  var je = me((In, Nt) => {
    ...
    Ye.triggers = {}
    Ye.types = { INTRO: 'w-ix-intro' + Pt, OUTRO: 'w-ix-outro' + Pt }
      ...
      (qt.exports = function (n, b) {
        ...
        function se (e, h) {
          ...
          c ||
            ...
            (c.complete = L(c)),
            (c.mouseLeave = X(c)),
            (c.mouseUpOutside = T(c)),
            (c.mouseMoveOutside = m(c)),
            ce(c)
          var $ = c.toggle.attr('id'),
            ie = c.list.attr('id')
          $ || ($ = 'w-dropdown-toggle-' + e),
            ie || (ie = 'w-dropdown-list-' + e),
            c.toggle.attr('id', $),
            c.toggle.attr('aria-controls', ie),
            ...
            c.list.attr('id', ie),
            c.list.attr('aria-labelledby', $),
            c.links.each(function (i, x) {
              x.hasAttribute('tabindex') || x.setAttribute('tabindex', '0'),
                pn.test(x.hash) && x.addEventListener('click', _.bind(null, c))
            }),
            c.el.off(y),
            c.toggle.off(y),
            c.nav && c.nav.off(y)
          ...
          W && c.el.on(k, fe(c)),
            W ||
              (V && ((c.hovering = !1), _(c)),
              c.config.hover && c.toggle.on(H, B(c)),
              c.el.on(P, G),
              c.el.on(I, S(c)),
              c.el.on(J, s(c)),
              c.toggle.on(q, G),
        ...
        function fe (e) {
          return function (h, g) {
            ;(g = g || {}),
              ce(e),
              g.open === !0 && de(e, !0),
              g.open === !1 && _(e, { immediate: !0 })
          }
        }
        function we (e, h) {
          return p(function (g) {
            if (e.open || (g && g.type === 'w-close'))
              return _(e, { forceClose: h })
            de(e)
          })
        }
        function de (e) {
          if (!e.open) {
            w(e),
              ...
              ne.intro(0, e.el[0]),
              Ne.redraw.up(),
              e.manageZ && e.el.css('z-index', K + 1)
            var h = Ne.env('editor')
            W || F.on(q, e.mouseUpOutside),
              e.hovering && !h && e.el.on(Q, e.mouseLeave),
              e.hovering && h && F.on(Y, e.mouseMoveOutside),
              window.clearTimeout(e.delayId)
          }
        }
        function _ (e, { immediate: h, forceClose: g } = {}) {
          if (e.open && !(e.config.hover && e.hovering && !g)) {
            e.toggle.attr('aria-expanded', 'false'), (e.open = !1)
            var c = e.config
            if (
              (ne.outro(0, e.el[0]),
              F.off(q, e.mouseUpOutside),
              F.off(Y, e.mouseMoveOutside),
              e.el.off(Q, e.mouseLeave),
              window.clearTimeout(e.delayId),
              !c.delay || h)
            )
              return e.complete()
        ...
        function T (e) {
          return (
            e.mouseUpOutside && F.off(q, e.mouseUpOutside),
            p(function (h) {
              if (e.open) {
                var g = n(h.target)
        ...
        function L (e) {
          return function () {
            e.list.removeClass(Z),
              e.toggle.removeClass(Z),
          ...
          return function (h) {
            if (!(W || !e.open))
              switch (
                ...
                case Ce.HOME:
                  return e.open
                    ? ((e.selectedIdx = 0), r(e), h.preventDefault())
                    : void 0
                case Ce.END:
                  return e.open
        ...
        function s (e) {
          return p(function (h) {
            var { relatedTarget: g, target: c } = h,
              $ = e.el[0],
              ie = $.contains(g) || $.contains(c)
  ...
  var Xt = me((Fn, Bt) => {
    ...
    Ze.define(
      ...
      (Bt.exports = function (n, b) {
        ...
        function P () {
          ;(y = n('html').attr('data-wf-site')),
            (H = 'https://webflow.com/api/v1/form/' + y),
            W &&
        ...
        function F () {
          ...
          E.on(
            'change',
            M + ' form input[type="checkbox"]:not(' + m + ')',
            g => {
              n(g.target).siblings(m).toggleClass(r)
            }
          ),
            E.on('change', M + ' form input[type="radio"]', g => {
              n(`input[name="${g.target.name}"]:not(${m})`).map(($, ie) =>
                n(ie).siblings(S).removeClass(r)
              )
              let c = n(g.target)
            ...
            h.forEach(([g, c]) => {
              E.on(
                'focus',
                M + ` form input[type="${g}"]:not(` + c + ')',
                $ => {
                  n($.target).siblings(c).addClass(o),
                    n($.target).filter(e).siblings(c).addClass(s)
                }
              ),
                E.on(
                  'blur',
            ...
            m
              ...
              .each(function (o, s) {
                var e = n(s),
                  h = e.attr('type'),
                  g =
                    e.attr('data-name') || e.attr('name') || 'Field ' + (o + 1)
        ...
        function ce (m) {
          var S = {}
          return (
            m.find(':input[type="file"]').each(function (r, o) {
              var s = n(o),
        ...
        function v (m) {
          ...
          b.each(r, function (c, $) {
            Z.test($) && (r.EMAIL = c),
              /^((full[ _-]?)?name)$/i.test($) && (s = c),
              /^(first[ _-]?name)$/i.test($) && (r.FNAME = c),
              /^(last[ _-]?name)$/i.test($) && (r.LNAME = c)
          }),
            s &&
              !r.FNAME &&
              ((s = s.split(' ')),
          ...
          ;(g = e.substring(g, e.indexOf('&', g))),
            (r['b_' + h + '_' + g] = ''),
            n
              .ajax({ url: e, data: r, dataType: 'jsonp' })
              .done(function (c) {
                ;(m.success = c.result === 'success' || /already/.test(c.msg)),
                  m.success || console.info('MailChimp error: ' + c.msg),
                  w(m)
              })
              .fail(function () {
                w(m)
        ...
        function L (m, S) {
          ...
          if (
            (J ||
              $.on('click keydown', function (u) {
                ;(u.type === 'keydown' && u.which !== 13 && u.which !== 32) ||
                  (u.preventDefault(), c.click())
              }),
            ...
            x.on('click keydown', function (u) {
              ...
              c.on('change', function (u) {
                ;(r = u.target && u.target.files && u.target.files[0]),
                  r &&
                    (s.toggle(!1),
                    g.toggle(!1),
                    e.toggle(!0),
        ...
        function B (m, S) {
          var r = new URLSearchParams({ name: m.name, size: m.size })
      ...
      (Kt.exports = function (n, b) {
        ...
        function fe (i, x) {
          ...
          O ||
            ...
            (O.button = D.find('.w-nav-button')),
            (O.container = D.find('.w-container')),
            (O.overlayContainerId = 'w-nav-overlay-' + i),
            (O.outside = r(O))
          ...
          oe &&
            ...
            v(O),
            Z
              ? (de(O), O.el.on('setting' + I, w(O)))
              : (_(O),
                O.button.on('click' + I, m(O)),
                O.menu.on('click' + I, 'a', S(O)),
                O.button.on('keydown' + I, T(O)),
                O.el.on('keydown' + I, L(O))),
            s(i, x)
        }
        function we (i, x) {
          var D = n.data(x, I)
        ...
        function v (i) {
          ...
          ;(x.animOver = /^over/.test(O)),
            (x.animDirect = /left$/.test(O) ? -1 : 1),
            D.animation !== O && i.open && b.defer(X, i),
            (x.easing = i.el.attr('data-easing') || 'ease'),
            (x.easing2 = i.el.attr('data-easing2') || 'ease')
          var oe = i.el.attr('data-duration')
          ;(x.duration = oe != null ? Number(oe) : 400),
            (x.docHeight = i.el.attr('data-doc-height')),
            (i.config = x)
        }
        function w (i) {
          return function (x, D) {
        ...
        function r (i) {
          return (
            i.outside && C.off('click' + I, i.outside),
            function (x) {
              var D = n(x.target)
              ;(ne && D.closest('.w-editor-bem-EditorOverlay').length) ||
                o(i, D)
            }
          )
        }
        ...
        function $ (i, x) {
          ...
          ;(i.open = !0),
            i.menu.each(g),
            i.links.addClass(P),
            i.dropdowns.addClass(Y),
            i.dropdownToggle.addClass(Q),
            i.dropdownList.addClass(q),
            i.button.addClass(H)
          var D = i.config,
            O = D.animation
          ...
          if (
            (i.overlay &&
              ((F = i.menu.prev()), i.overlay.show().append(i.menu)),
            D.animOver)
          ) {
            E(i.menu)
              .add(l)
              .set({ x: D.animDirect * _e, height: oe })
              .start({ x: 0 })
              .then(u),
              i.overlay && i.overlay.width(_e)
            return
          }
          var f = t + xe
          E(i.menu).add(l).set({ y: -f }).start({ y: 0 }).then(u)
          function u () {
        ...
        function ie (i) {
          ...
          return (
            x.animOver
              ? i.menu.height(D)
              : i.el.css('position') !== 'fixed' && (D -= i.el.outerHeight(!0)),
            i.overlay && i.overlay.height(D),
            D
          )
        }
        function G (i, x) {
          ...
          if (D.animOver) {
            E(i.menu)
              .add(O)
              .start({ x: xe * D.animDirect })
              .then(a)
            return
          }
          var t = _e + oe
          E(i.menu).add(O).start({ y: -t }).then(a)
          function a () {
            i.menu.height(''),
              E(i.menu).set({ x: 0, y: 0 }),
              i.menu.each(c),
              i.links.removeClass(P),
              i.dropdowns.removeClass(Y),
              i.dropdownToggle.removeClass(Q),
              i.dropdownList.removeClass(q),
              i.overlay &&
                i.overlay.children().length &&
                (F.length ? i.menu.insertAfter(F) : i.menu.prependTo(i.parent),
      ...
      (Vt.exports = function (n, b) {
        ...
        function k (r, o) {
          ...
          e.el.off(y),
            ...
            F(e),
            W
              ? (e.el.on('setting' + y, v(e)), _(e), (e.hasTimer = !1))
              : (e.el.on('swipe' + y, v(e)),
                e.left.on('click' + y, ce(e)),
                e.right.on('click' + y, fe(e)),
                e.left.on('keydown' + y, se(e, ce)),
                e.right.on('keydown' + y, se(e, fe)),
                e.nav.on('keydown' + y, '> div', v(e)),
                e.config.autoplay &&
                  !e.hasTimer &&
                  ((e.hasTimer = !0), (e.timerCount = 1), de(e)),
                e.el.on('mouseenter' + y, U(e, !0, 'mouse')),
                e.el.on('focusin' + y, U(e, !0, 'keyboard')),
                e.el.on('mouseleave' + y, U(e, !1, 'mouse')),
                e.el.on('focusout' + y, U(e, !1, 'keyboard'))),
            e.nav.on('click' + y, '> div', v(e)),
            M ||
              e.mask
                .contents()
                .filter(function () {
        ...
        function F (r) {
          var o = {}
          ;(o.crossOver = 0),
            (o.animation = r.el.attr('data-animation') || 'slide'),
            o.animation === 'outin' &&
              ((o.animation = 'cross'), (o.crossOver = 0.5)),
            (o.easing = r.el.attr('data-easing') || 'ease')
          var s = r.el.attr('data-duration')
          if (
            ((o.duration = s != null ? parseInt(s, 10) : 500),
            R(r.el.attr('data-infinite')) && (o.infinite = !0),
            R(r.el.attr('data-disable-swipe')) && (o.disableSwipe = !0),
            R(r.el.attr('data-hide-arrows'))
              ? (o.hideArrows = !0)
              : r.config.hideArrows && (r.left.show(), r.right.show()),
            R(r.el.attr('data-autoplay')))
          ) {
            ;(o.autoplay = !0),
              (o.delay = parseInt(r.el.attr('data-delay'), 10) || 2e3),
              (o.timerMax = parseInt(r.el.attr('data-autoplay-limit'), 10))
        ...
        function U (r, o, s) {
          return function (e) {
            if (o) r.hasFocus[s] = o
              ...
              n.contains(r.el.get(0), e.relatedTarget) ||
              ((r.hasFocus[s] = o),
              (r.hasFocus.mouse && s === 'keyboard') ||
                (r.hasFocus.keyboard && s === 'mouse'))
            )
              return
            o
              ? (r.ariaLiveLabel.attr('aria-live', 'polite'),
                r.hasTimer && _(r))
              : (r.ariaLiveLabel.attr('aria-live', 'off'), r.hasTimer && de(r))
          }
        }
        function se (r, o) {
          return function (s) {
        ...
        function we (r, o) {
          var s = null
          o === r.slides.length && (Y(), B(r)),
            b.each(r.anchors, function (e, h) {
              n(e.els).each(function (g, c) {
                n(c).index() === o && (s = h)
              })
            }),
            s != null && T(r, { index: s, immediate: !0 })
        }
        function de (r) {
          _(r)
          var o = r.config,
        ...
        function v (r) {
          return function (o, s) {
            ...
            if (o.type === 'swipe')
              return e.disableSwipe || Me.env('editor')
                ? void 0
                : s.direction === 'left'
                ? fe(r)()
                : s.direction === 'right'
            ...
            if (r.nav.has(o.target).length) {
              ...
              if (
                (o.type === 'click' && T(r, { index: h }), o.type === 'keydown')
              )
                switch (o.keyCode) {
                  case We.ENTER:
                  case We.SPACE: {
                    T(r, { index: h }), o.preventDefault()
                    break
                  }
                  case We.ARROW_LEFT:
                  case We.ARROW_UP: {
                    w(r.nav, Math.max(h - 1, 0)), o.preventDefault()
                    break
                  }
                  case We.ARROW_RIGHT:
                  case We.ARROW_DOWN: {
                    w(r.nav, Math.min(h + 1, r.pages)), o.preventDefault()
                    break
                  }
                  case We.HOME: {
                    w(r.nav, 0), o.preventDefault()
                    break
                  }
                  case We.END: {
                    w(r.nav, r.pages), o.preventDefault()
                    break
                  }
                  default:
                    return
        ...
        function T (r, o) {
          ...
          h < 0
            ? ((h = e.length - 1),
              s.infinite &&
                ((g.x = -r.endX), (g.from = 0), (g.to = e[0].width)))
            : h >= e.length &&
              ((h = 0),
              s.infinite &&
                ((g.x = e[e.length - 1].width),
                (g.from = -e[e.length - 1].x),
                (g.to = g.from - g.x))),
            (r.index = h)
          var c = r.nav
            .children()
          ...
          r.nav
            ...
            .attr('tabindex', '-1'),
            s.hideArrows &&
              (r.index === e.length - 1 ? r.right.hide() : r.right.show(),
              r.index === 0 ? r.left.hide() : r.left.show())
          var $ = r.offsetX || 0,
            ie = (r.offsetX = -e[r.index].x),
            G = { x: ie, opacity: 1, visibility: '' },
            i = n(e[r.index].els),
          ...
          if (
            (i.find(Gt).removeAttr('tabindex'),
            i.removeAttr('aria-hidden'),
            i.find('*').removeAttr('aria-hidden'),
            D.find(Gt).attr('tabindex', '-1'),
            D.attr('aria-hidden', 'true'),
            D.find('*').attr('aria-hidden', 'true'),
            W || (i.each(J.intro), D.each(J.outro)),
            o.immediate && !H)
          ) {
            E(i).set(G), u()
            return
          ...
          if (
            (W || r.ariaLiveLabel.text(`Slide ${h + 1} of ${e.length}.`),
            O === 'cross')
          ) {
            var l = Math.round(xe - xe * s.crossOver),
              f = Math.round(xe - l)
            ;(t = 'opacity ' + l + 'ms ' + oe),
              E(x).set({ visibility: '' }).add(t).start({ opacity: 0 }),
              E(i)
                .set({ visibility: '', x: ie, opacity: 0, zIndex: r.depth++ })
                .add(t)
                .wait(f)
                .then({ opacity: 1 })
                .then(u)
          ...
          s.infinite && g.x
            ? (E(r.slides.not(x))
                ...
                .add(a)
                .start({ x: ie }),
              E(x).set({ visibility: '', x: g.from }).add(a).start({ x: g.to }),
              (r.shifted = x))
            : (s.infinite &&
                r.shifted &&
                (E(r.shifted).set({ visibility: '', x: $ }),
                (r.shifted = null)),
              E(r.slides).set({ visibility: '' }).add(a).start({ x: ie }))
          function u () {
            ;(i = n(e[r.index].els)),
              (D = r.slides.not(i)),
              O !== 'slide' && (G.visibility = 'hidden'),
              E(D).set(G)
          }
        }
        function L (r, o) {
          ...
          c < 0 && (c = 0),
            ...
            r.slides.each(function (ie, G) {
              e - s > c &&
                (o++,
                (s += g),
                (r.anchors[o - 1] = { els: [], x: e, width: 0 })),
                (h = n(G).outerWidth(!0)),
                (e += h),
                (r.anchors[o - 1].width += h),
                r.anchors[o - 1].els.push(G)
              var i = ie + 1 + ' of ' + r.slides.length
              n(G).attr('aria-label', i), n(G).attr('role', 'group')
            }),
            (r.endX = e),
            W && (r.pages = null),
            r.nav.length && r.pages !== o && ((r.pages = o), X(r))
          var $ = r.index
          $ >= o && ($ = o - 1), T(r, { immediate: !0, index: $ })
        }
        function X (r) {
          var o = [],
            s,
          ...
          e && (e = parseFloat(e) + 'px')
          for (var h = 0, g = r.pages; h < g; h++)
            (s = n(Z)),
              s
                .attr('aria-label', 'Show slide ' + (h + 1) + ' of ' + g)
                .attr('aria-pressed', 'false')
                .attr('role', 'button')
                .attr('tabindex', '-1'),
              r.nav.hasClass('w-num') && s.text(h + 1),
              e != null && s.css({ 'margin-left': e, 'margin-right': e }),
              o.push(s)
